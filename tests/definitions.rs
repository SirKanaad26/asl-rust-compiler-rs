...
#[test]
fn type_alias() {
    let out = run_compiler("definitions", "examples/defs/type_alias.asl");
    assert!(out.contains("pub type"), "expected type alias, got:\n{out}");
}

#[test]
fn enum_def() {
    let out = run_compiler("definitions", "examples/defs/enum.asl");
    assert!(out.contains("pub enum"), "expected enum, got:\n{out}");
}

#[test]
fn struct_def() {
    let out = run_compiler("definitions", "examples/defs/struct.asl");
    assert!(out.contains("pub struct"), "expected struct, got:\n{out}");
}

#[test]
fn builtin_type() {
    let out = run_compiler("definitions", "examples/defs/builtin_type.asl");
    assert!(out.contains("// builtin:"), "expected builtin comment, got:\n{out}");
}

#[test]
fn abstract_type() {
    let out = run_compiler("definitions", "examples/defs/abstract_type.asl");
...
#[test]
fn type_array() {
    let out = run_compiler("definitions", "examples/defs/type_array.asl");
...
#[test]
fn variable() {
    let out = run_compiler("definitions", "examples/defs/variable.asl");
...
#[test]
fn constant() {
    let out = run_compiler("definitions", "examples/defs/constant.asl");
    assert!(out.contains("pub const MAX: i128 = 100;"), "missing MAX:\n{out}");
}

#[test]
fn array_def() {
    let out = run_compiler("definitions", "examples/defs/array_def.asl");
...
#[test]
fn getter_setter() {
    let out = run_compiler("definitions", "examples/defs/getter_setter.asl");
    // Simple getter
