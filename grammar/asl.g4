...
definition:
    ...
    | 'array' typeSpec id '[' ixType ']' SEMICOLON                       #DefArray
...
setterArg:
      typeSpec '&' id                                                    #SetterRefArg
    | typeSpec id                                                        #SetterValArg
    ;
...
typeSpec:
    ...
    | 'array' '[' ixType ']' 'of' typeSpec                    #TypeArray
    ;
...
indentedBlock: stmt+ ;  // One or more statements required
...
inlineStmt:
      typeSpec identifierCommaList1                           #StmtVarsDecl
...
expr:
    ...
    | typeSpec 'UNKNOWN'                                      #ExprUnknown
    | typeSpec 'IMPLEMENTATION_DEFINED' STRING_LIT?           #ExprImpDef
...
slice:
    ...
    | sliceBase=sliceExpr '+:' count=sliceExpr            #SliceOffset
    | expr                                                #SliceSingle
    ;
